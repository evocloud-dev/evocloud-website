  ...
  return (
    <>
      <section className="relative h-max md:h-[85vh] bg-cover bg-center px-4 py-6 md:px-4 md:py-16 flex items-center justify-center bg-linear-to-b from-accent to-primary text-background">
        <FaShield className="absolute opacity-25 text-[10rem] top-1/2 left-[20%] -translate-x-1/2 -translate-y-1/2 text-background z-0 pointer-events-none hidden md:block" />
        <FaShield className="absolute opacity-20 text-[15rem] top-1/2 left-[20%] -translate-x-1/2 -translate-y-1/2 text-background z-0 pointer-events-none hidden md:block" />
        <FaShield className="absolute opacity-15 text-[20rem] top-1/2 left-[20%] -translate-x-1/2 -translate-y-1/2 text-background z-0 pointer-events-none hidden md:block" />
        <FaShield className="absolute opacity-10 text-[25rem] top-1/2 left-[20%] -translate-x-1/2 -translate-y-1/2 text-background z-0 pointer-events-none hidden md:block" />
        <FaShield className="absolute opacity-5 text-[30rem] top-1/2 left-[20%] -translate-x-1/2 -translate-y-1/2 text-background z-0 pointer-events-none md:hidden" />

        <div className="md:max-w-screen-xl flex justify-end z-10">
