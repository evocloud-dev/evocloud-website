      ...
      <div className="max-w-screen-xl w-full mx-auto space-y-10">
        ...
        <Cards className="md:grid-cols-3">
          <Card className="min-h-60">
            <P1 className="text-tertiary font-semibold flex flex-row items-center gap-2">
              <GrSystem size={25} />
              <span>Totally flexible infrastructure</span>
            </P1>
            <div className="mb-6">
              <P1 className="text-black text-sm flex flex-row items-center gap-2 leading-relaxed tracking-wide">
